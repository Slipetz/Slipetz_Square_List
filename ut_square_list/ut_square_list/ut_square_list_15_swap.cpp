...
BOOST_AUTO_TEST_CASE( ut_swap_empty_to_empty ) {
...
BOOST_AUTO_TEST_CASE( ut_swap_pop_to_empty ) {
	square_list<char> a, b;
...
BOOST_AUTO_TEST_CASE( ut_swap_empty_to_populated ) {
	square_list<char> a, b;
...
BOOST_AUTO_TEST_CASE( ut_swap_populated_to_populated ) {
	square_list<char> a, b;
